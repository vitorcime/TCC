...
training_generator = MixupDataGenerator(X_train, Y_train, batch_size=256, shuffle=True, mixup_alpha=0.2)
...
h = model.fit(training_generator, epochs=500, callbacks=[ES], validation_data=validation_generator,
